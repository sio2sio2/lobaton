...
.. js:method:: MutableMarker.invoke(metodo, progress, arg1, arg2, ...)
   ...
   ``.invoke()``. Lo que se hace internamente es lanzar sucesivamente durante 200ms el método
   para cada marca y al cumplirse este intervalo, ejecutar la función ``progress`` y
