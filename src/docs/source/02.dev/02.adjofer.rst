...
:ref:`objeto de manipulación del mapa <crea-mapadjofer>`_ añade un **atributo**:
...
.. js:attribute:: solicitud
   ...
   añade el centro con el código indicado al final de la lista de peticiones.

Además de este atributo, los centros tiene dos características más relacionadas
con la petición de destinos:

* Entre sus datos un atributo llamado petición que indica cuál en que posición
  se pidio el centro. Si el centro no está pedido, vale **0**. Al comienzo,
  todos los centros tiene este atributo a **0**.
...
.. seealso:: Revice los referente a localidades, indicado :ref:`más adelante
   <adjofer-localidades>`_.
...
.. js:method:: add(centro)
   ...
   Ejemplo::
      ...
      g.solicitud.list;  // Devuelve ["11004866C", "21002100C", "23001111C"]
...
.. js:method:: delete(pos, cuantos)
   ...
   *cuántos* a partir de la posición indicada::

      g.solicitud.delete(2, 2);
      g.solicitud.list;  // Devuelve ["11004866C"]
