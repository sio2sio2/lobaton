...
.. js:attribute:: Centro
   ...
   Por otra parte a los datos se incorpora un *getter*, que permite obtener
   el código normalizado del centro::
...
.. js:attribute:: Localidad
   ...
   Además, también como se hace con :js:attr:`Centro`, se incorporta un *getter* a los
   datos que facilita el código normalizado::
