...
que ajustas su aspecto al valor de sus datos, esto es, que son capaces de
...
En caso de que la corrección sirva para añdir elementos, no se recorrerá el
array alemento por elemento, sino que la función se ejecutará una v vez y deberá
